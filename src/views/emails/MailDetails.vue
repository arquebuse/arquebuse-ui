    ...
    <CCol col="12" xl="12">
      <transition name="fade">
        <CCard>
          ...
          <CCardBody>
            <CListGroup>
              <CListGroupItem :color="getStatusColor(status)" href="#" v-if="status !== 'undefined'">
              ...
              <CListGroupItem href="#" v-if="client !== ''">
                <strong>Received from: </strong>{{client}}
              </CListGroupItem>

              <CListGroupItem href="#" v-if="server !== ''">
              ...
              <CListGroupItem color="warning" href="#" v-if="parseErrors.length > 0 ">
              ...
              <CListGroupItem href="#" v-if="headers.length > 0">
              ...
              <CListGroupItem href="#" v-if="text !== ''">
                <strong>Text message: </strong>
                <pre style="margin-left: 15px">{{text}}</pre>
              </CListGroupItem>

              <CListGroupItem href="#" v-if="html !== ''">
                <strong>HTML message: </strong>
                <pre style="margin-left: 15px">{{html}}</pre>
              </CListGroupItem>

              <CListGroupItem href="#">
                <strong>Raw data: </strong>
                <pre style="margin-left: 15px">{{data}}</pre>
              </CListGroupItem>
            </CListGroup>
          </CCardBody>
          <CCardFooter>
